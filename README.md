...
Currently reinforcing my linear algebra and numerial analysis by reimplementing basic, fundamental algorithms in Python. Inspired by [Alex Nichol's Go repository](https://github.com/unixpickle/num-analysis).

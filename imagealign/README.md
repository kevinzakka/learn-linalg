...
<p align="center">
 <img src="./assets/p3.png" alt="Drawing", width=60%>
</p>

Since this is in standard form, we obtain the solution as follows:

<p align="center">
 <img src="./assets/p4.png" alt="Drawing", width=30%>
</p>

and we can apply Cholesky factorization to solve for `M∗` which is then rearranged to find `M`.
